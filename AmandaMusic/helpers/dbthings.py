...
from AmandaMusic.helpers.database import db, Database, dcmdb
from AmandaMusic.config import LOG_CHANNEL, BROADCAST_AS_COPY
...
async def handle_user_status(bot, cmd):
    ...
    if ban_status["is_banned"]:
        if (
            ...
            await cmd.reply_text("Sorry To Say! but **You are banned** 😂! Ask in **@TheAmandabot** if you think this was an mistake.", quote=True)
            return
