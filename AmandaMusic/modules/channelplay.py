...
from AmandaMusic.modules.play import generate_cover
from AmandaMusic.modules.play import arq
from AmandaMusic.modules.play import cb_admin_check
from AmandaMusic.modules.play import transcode
from AmandaMusic.modules.play import convert_seconds
from AmandaMusic.modules.play import time_to_seconds
from AmandaMusic.modules.play import changeImageSize
from AmandaMusic.config import BOT_NAME as bn
from AmandaMusic.config import DURATION_LIMIT
from AmandaMusic.config import UPDATES_CHANNEL as updateschannel
from AmandaMusic.config import que
from AmandaMusic.function.admins import admins as a
from AmandaMusic.helpers.errors import DurationLimitError
from AmandaMusic.helpers.decorators import errors
from AmandaMusic.helpers.admins import get_administrators
from AmandaMusic.helpers.channelmusic import get_chat_id
from AmandaMusic.helpers.decorators import authorized_users_only
from AmandaMusic.helpers.filters import command
from AmandaMusic.helpers.filters import other_filters
from AmandaMusic.helpers.gets import get_file_name
from AmandaMusic.services.callsmusic import callsmusic
from AmandaMusic.services.callsmusic import client as USER
from AmandaMusic.services.converter.converter import convert
from AmandaMusic.services.downloaders import youtube
from AmandaMusic.services.queues import queues
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/e8f3eedc2f4a286a9fe7e.jpg"
...
async def jiosaavn(client: Client, message_: Message):
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @TheAmandabot to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
    ...
    try:
        ...
        sthumb = "https://telegra.ph/file/e8f3eedc2f4a286a9fe7e.jpg"
    ...
    m = await client.send_photo(
        ...
        reply_markup=keyboard,
        photo="final.png",
        caption=f"Playing {sname} Via Amanda Music in linked channel",
    )
    os.remove("final.png")
