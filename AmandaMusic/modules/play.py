...
from AmandaMusic.config import ARQ_API_KEY
...
async def play(_, message: Message):
            ...
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        ...
                        "\n\nor manually add [assistant](https://t.me/TheAmandaMusicbot) to your Group and try again</b>",
                    )
    try:
    ...
    if chat_id in callsmusic.active_chats:
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="▶️ <b>Playing</b> here the song requested by {} via <b>Amanda Music</b> 😎".format(message.from_user.mention()),
        )
        os.remove("final.png")
        return await lel.delete()
...
async def deezer(client: Client, message_: Message):
    ...
    try:
        ...
        thumbnail = "https://telegra.ph/file/e8f3eedc2f4a286a9fe7e.jpg"
...
async def lol_cb(b, cb):
    ...
    if chat_id in callsmusic.active_chats:
        ...
        await b.send_photo(chat_id,
            photo="final.png",
            reply_markup=keyboard,
            caption=f"▶️ <b>Playing</b> here the song requested by {r_by.mention} via <b>Amanda Music</b> 😎",
        )
