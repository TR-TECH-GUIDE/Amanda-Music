...
from AmandaMusic.services.callsmusic import client as pakaya
from AmandaMusic.helpers.database import db
from AmandaMusic.helpers.dbthings import main_broadcast_handler
from AmandaMusic.modules.song import humanbytes, get_text
from AmandaMusic.config import BOT_USERNAME, OWNER_ID, UPSTREAM_REPO, U_BRANCH, HEROKU_URL, HEROKU_API_KEY, HEROKU_APP_NAME, SUDO_USERS
    ...
    try:
        ...
        try:
            await c.send_message(
                user_id,
                f"Lmao You are **Banned 😂!** \n\nReason: `{ban_reason}` \nDuration: `{ban_duration}` day(s). \n\n**Message From The Owner! Ask in **@trtechguide** if you think this was an mistake."
            )
